#!/usr/bin/env python3
"""Build an Anki .apkg study deck for the French course (A1-A2 beginner).
...
Run:  python3 build_anki.py     (from the french folder; needs `genanki`)
Output: french_course.apkg
"""
import json
import os
import re
...
""",
    ...
    deck = genanki.Deck(DECK_ID, "French Course (A1-A2)")
    ...
    out = os.path.join(HERE, "french_course.apkg")
